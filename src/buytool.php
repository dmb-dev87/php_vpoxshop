  ...
  if($balance >= $price){
    ...
    if($ree['sold'] == '0'){
           $npur = $ipur + 1 ;
			...
			$qyery = mysqli_query($dbcon, "INSERT INTO purchases
            (id,buyer,date,type,country,infos,url,login,pass,price,resseller,reported,reportid)
            VALUES
            ('$sid','$usrid','$date','$type','$fb','$infos','$url','$login','$pa','$price','$resseller','0','0')
