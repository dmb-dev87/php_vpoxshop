...
if($balance >= $price){
  ...
  if($ree['sold'] == '0' OR $ree['sold'] == '1') {
    ...
    mysqli_query($dbcon, "INSERT INTO purchases (s_id,buyer,date,type,country,infos,url,login,pass,price,resseller,reported,reportid) VALUES ('$sid','$usrid','$date','$type','$fb','$tutoname | $infos','$url','$login','$pa','$price','$resseller','','')");
