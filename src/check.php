...
$a = $row["address"];
    ...
    $page = _curl($url, '', '');
		...
		echo '
{"stop":"1","time":"'.date("Y/m/d h:i:s").'","btc":"'.$amount.'","state":"Paid","error":"1","errorTXT":"'.$msg.'"}';
	echo '
	
{"stop":"1","time":"'.date("Y/m/d h:i:s").'","btc":"'.$amount.'","state":"Paid","error":"1","errorTXT":"<div class="alert alert-dismissible alert-success"><strong>Payment Received! <i class="glyphicon glyphicon-ok"></i></strong><p>An amount of <b>$y$</b> has been added to your balance.</p></div>"}'; }
...
{"stop":"1","time":"'.date("Y/m/d h:i:s").'","btc":"'.$amount.'","state":"Paid","error":"1","errorTXT":"'.$msg.'"}';
		...
		echo '
{"stop":"0","time":"'.date("Y/m/d h:i:s").'","btc":"'.$amount.'","state":"Not Paid","error":"0","errorTXT":"0"}';
