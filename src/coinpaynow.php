 ...
 <div id="myTabContent" class="tab-content">
	<div class="tab-pane fade active in" id="addBalance">
		...
		<div id="">
			...
			<br />
			<a href="coinmoney.php?p_data=<?php echo $p_data; ?>"  target="_blank" class="tabeladugme btn btn-danger btn-lg" style="padding: 12px 20px;"><img src="https://www.coinpayments.net/images/pub/buynow.png"></a><br><br>
				</div>
