...
function check(id){
  if(xcheck > 2){
    ...
    var type = $("#shop"+id).attr('type')
  	$("#shop"+id).html('Sending...').show();	/*alert(xcheck); */		
    if(xcheck == '2') {
      ...
      var getDataValue2 =  window.setInterval(function(){	
        $.ajax({	
          type: 	'GET',	
          url: 		'CheckSMTP'+id+'.html',	
          success:	function(data) {		
        ...
        window.clearInterval(getDataValue2);	
      },10000);	
    } else if(xcheck == '4') {		
      var getDataValue3 =  window.setInterval(function(){	
        $.ajax({	
          type: 	'GET',	
          url: 		'CheckSMTP'+id+'.html',	
          success:	function(data) {		
        ...
        window.clearInterval(getDataValue3);	
      },15000);	
    } else {
      $.ajax({
        type: 	'GET',
