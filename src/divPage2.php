...
<td>
<input class='filterinput form-control input-sm' name="cpanel_tld" size='3'></td>
<td><select class='filterselect form-control input-sm' name="shell_ssl">
<option value="">ALL</option>
<option value="https">HTTPS</option>
<option value="http">HTTP</option></select></td>

<td>
<input class='filterinput form-control input-sm' name="cpanel_hosting" size='3'></td>


<td><select class='filterselect form-control input-sm' name="cpanel_seller"><option value="">ALL</option>
<?php
...
$('#filterbutton').click(function () {
	$("#table tbody tr").each(function() {
		...
		var ck5 = $.trim( $(this).find("#shell_ssl").text().toLowerCase() );
		...
		var val5 = $.trim( $('select[name="shell_ssl"]').val()); 
		if((ck1 != val1 && val1 != '' ) || ck2.indexOf(val2)==-1 || ck3.indexOf(val3)==-1 || (ck4 != val4 && val4 != '' ) || (ck5 != val5 && val5 != '' )){ 
		$(this).hide();
		}else{ $(this).show();
		} 
		});
