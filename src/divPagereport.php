    ...
    $.ajax({
           ...
           success: function(data)
           {
            if (data == 01) {
             ...
             if (data != 01) {
              pageDiv('report<?php echo $tid; ?>','Report #<?php echo $tid; ?> - Vpox SHOP','showReport<?php echo $tid; ?>.html',1);
...
?>
            ...
            <div class="bs-component">
              <div class="well well" style="margin-top:55px;">
                <h5><b>Item Information</b></h5>
				<?php
           	///////////////// Cpanel
 if ($rrrrx['acctype'] == "cpanel") {
	 $itemid = $rrrrx['s_id'];
$qe = mysqli_query($dbcon, "SELECT * FROM cpanels WHERE cp_id='$itemid'") or die(mysql_error());
...
<tr>
  ...
  <tr>
  <td>Username</td>
  <td><b><input id='username' onClick='this.setSelectionRange(0, this.value.length)' class="form-control" value='<?php echo htmlspecialchars($login); ?>' /></b></td>
</tr>

  <tr>
  <td>Password</td>
  <td><b><input id='password' onClick='this.setSelectionRange(0, this.value.length)' class="form-control" value='<?php echo htmlspecialchars($pass); ?>' /></b></td>
</tr>
