...
if (isset($_GET['id'])) {
    ...
    if (!empty($r)) {
        ...
        switch ($st) {
            case "0":
                $st = "<font color='green'>Resolved</font>";
                break;
            case "1":
        ...
        echo '
<div class="form-group col-lg-5 " style="overflow:scroll; height:500px;">
...
<div class="col-lg-7" style="position:fixed;left:41%">
    ...
    $.ajax({
           ...
           success: function(data)
           {
            if (data == 01) {
             ...
             if (data != 01) {
              pageDiv('ticket<?php echo $tid; ?>','Ticket #<?php echo $tid; ?> - Vpox SHOP','showTicket<?php echo $tid; ?>.html',1);
