    ...
    <div class="collapse navbar-collapse" id="topFixedNavbar1">
        ...
        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fas fa-mail-bulk" aria-hidden="true"></i>&nbsp;Send <span class="doar" id="mail"></span></a>
          <ul class="dropdown-menu" role="menu">
            ...
            <li><a href="smtp.html" onclick="pageDiv(5,'SMTP - VpoxShop','smtp.html',0); return false;"><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;SMTPs <span class="label label-primary label-as-badge" id="smtp"></span></a></li>
			      <li><a href="webmail.html" onclick="pageDiv(18,'WebMail - VpoxShop','webmail.html',0); return false;"><i class="fa fa-download" aria-hidden="true"></i>&nbsp;WebMails <span class="label label-primary label-as-badge" id="webmail"></span></a></li>
          </ul>
        </li>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        ?>
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="tickets.html" onclick="pageDiv(11,'Tickets - VpoxShop','tickets.html',0); return false;"><i class="fa fa-comments" aria-hidden="true"></i>&nbsp;Tickets <span class="label label-info"><span id="tickets"></span></span>
            <?php
            ...
            ?></span></a></li>
            <li><a href="reports.html" onclick="pageDiv(12,'Reports - VpoxShop','reports.html',0); return false;"><i class="fa fa-flag" aria-hidden="true"></i>&nbsp;Reports <span class="label label-info"><span id="reports"></span></span> 
            <?php
