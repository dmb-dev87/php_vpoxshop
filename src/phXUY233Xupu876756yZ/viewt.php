...
//echo "SELECT * FROM ticket WHERE id='$myid'"; exit;
...
$qq = mysqli_query($dbcon, "UPDATE ticket SET memo = CONCAT(memo,'$msg'),status = '1',seen='1',lastreply='Admin',lastup='$date' WHERE id='$myid'")or die(mysqli_error($dbcon));
