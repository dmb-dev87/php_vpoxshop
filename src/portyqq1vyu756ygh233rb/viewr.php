...
<div class="form-group col-lg-5 scr">
...
$qq = mysqli_query($dbcon, "UPDATE reports SET memo = CONCAT(memo,'$msg'),status = '1',seen='1',lastreply='Support',lastup='$date' WHERE id='$myid'")or die("mysql error");
...
<tr>
  ...
  <tr>
  <td>Username</td>
  <td><b><input id='username' class="form-control" onClick='this.setSelectionRange(0, this.value.length)' value='<?php echo htmlspecialchars($login); ?>' /></b></td>
</tr>

  <tr>
  <td>Password</td>
  <td><b><input id='password' class="form-control"  onClick='this.setSelectionRange(0, this.value.length)' value='<?php echo htmlspecialchars($pass); ?>' /></b></td>
</tr>
