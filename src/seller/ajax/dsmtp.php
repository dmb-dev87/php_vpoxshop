...
$qu = mysqli_query($dbcon, "SELECT * FROM smtps WHERE id='$id' AND resseller='$resseller'")or die("error");
...
global $price ;
 ...
 include "../../includes/config.php";
  ...
  $q0 = mysqli_query($dbcon, "SELECT * FROM smtps WHERE id='$id' AND resseller='$resseller'")or die();
