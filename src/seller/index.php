...
If you have any <b> Question</b> , <b>Suggestion</b> or <b>Request Please</b> feel free to <a class="label label-default" href="../tickets.html"><span class="glyphicon glyphicon-pencil"></span> Open Ticket</a>
<br>
...
&nbsp;	&nbsp;	&bull;	You get <b>60%</b> of your sales<br>
...
<?php
    $qerz = mysqli_query($dbcon, "SELECT * FROM resseller WHERE username='".$uid."'")or die(mysql_error());
		   while($repw = mysqli_fetch_assoc($qerz))
			 $AddressBTC = $repw["btc"];
?>
&nbsp;	&nbsp;	&bull;	Your bitcoin address is <b><?php if (empty($AddressBTC)) {  echo "N/A"; }  else { echo htmlspecialchars($AddressBTC); }?></b><br>
<?php
...
&nbsp;	&nbsp;	&bull;	Your Whole Sales until now is <b><?php echo $sold ?>$</b><br>
&nbsp;	&nbsp;	&bull;	<i class="fa fa-exclamation-triangle" aria-hidden="true"></i>&nbsp;<a style="background: #dc3545;color: white;
font-size: 11px;padding: 5px;border-radius: 3px;">You have 0 warnings</a><br>
</font>
</td>
