...
<ul class="nav nav-tabs">
		...
		<li class=""><a href="#all" data-toggle="tab" aria-expanded="false" onclick="TabDiv('all','leadTab1.php?id=<?php echo $uid ?>')">All</a></li>
		<li class=""><a href="#add" data-toggle="tab" aria-expanded="false" onclick="TabDiv('add','leadTab2.php?id=<?php echo $uid ?>')">Add</a></li>
	<!--<li class=""><a href="#mass" data-toggle="tab" aria-expanded="false" onclick="TabDiv('mass','leadTab3.php?id=<?php echo $uid ?>')">Mass Add</a></li>-->
	</ul>
