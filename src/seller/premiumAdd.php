      ...
      else if (empty($website))
{
	...
	echo "<br><b>$host</b> .... <b>Price not valid!</b> <br>";
} else {
$check="SELECT * FROM accounts WHERE url = '$link'";
...
if($data[0] > 1) {
  ...
  (acctype,country,infos,price,url,sold,sto,dateofsold,date,resseller,reported,sitename)
  VALUES
  ('account','$country','$infos','$price','$link','0','','','$date','$uid','','$website')
