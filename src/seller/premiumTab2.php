...
<div class="row">
	<div class="form-group col-lg-3 ">
		...
		<input type="text" name="site" id="site" class="form-control input-sm" placeholder="site.com" required="">
	</div>
</div>
<div class="row">
	<div class="form-group col-lg-3 ">
		<label for="infos">Available Information</label>
		<input type="text" name="infos" id="infos" class="form-control input-sm" placeholder="Fresh paid account / expiration / etc .. 	" required="">
	</div>
	<div class="form-group col-lg-3 ">
...
$("#premiumAdd").submit(function() {
  $('button').prop('disabled', true);
    $.ajax({
           type: "POST",
           url: 'premiumAdd.html',
           data: $("#premiumAdd").serialize(),
