...
function ambilKata($param, $kata1, $kata2){
  ...
  $ramstorage = mysqli_real_escape_string($dbcon, $_POST['ramstorage']);
  $ram = $ram.''.$ramstorage;
...
$iptocity = "http://api.ipgeolocation.io/ipgeo?apiKey=b4692370f68e4c398039408226e6f99f&ip=$host&fields=city";
		...
		$state_prov = "http://api.ipgeolocation.io/ipgeo?apiKey=b4692370f68e4c398039408226e6f99f&ip=$host&fields=state_prov";
