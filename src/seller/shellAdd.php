            ...
            if ($match == '1') {
                ...
                $data  = mysqli_fetch_array($rs);
                    ...
                    if ($data != "") {
                        ...
                        $sql = mysqli_query($dbcon,"INSERT INTO stufs(acctype,country,infos,url,price,resseller,sold,date,dateofsold,reported,sto,domain,city,hosting,price_show,dateof_sold,access,windows,ram,server_info)VALUES('shell','$country','$hostingg','$k','$price','$uid','0','$date','$date','0','0','$o','0','$hostingg','$price','0','0','$sysos','0','$repls2')")or die (mysqli_error($dbcon));
                        //echo $sql;
