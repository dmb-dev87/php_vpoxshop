...
$iptocountry = "http://api.ipstack.com/$host?access_key=f991d31642a29f8a8197b57ef76f167b&fields=country_name";
    ...
    $query = mysqli_query($dbcon, "INSERT INTO smtps(acctype,country,infos,price,url,sold,sto,dateofsold,resseller,reported,city,hosting,price_show,dateof_sold,access,windows,ram,domain,date)
	
	VALUES('smtp','$countryy','$hostingg','$price','$link','0','0','$date','$uid','0','0','$hostingg','$price','$date','0','0','0','0','$date')")or die(mysqli_error($dbcon));
