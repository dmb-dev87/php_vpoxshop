...
{   var type = $("#shop"+id).attr('type')
	...
	<ul class="nav nav-tabs">
		...
		<li class=""><a href="#all" data-toggle="tab" aria-expanded="false" onclick="TabDiv('all','sshTab1.php?id=<?php echo $uid ?>')">All</a></li>
		<li class=""><a href="#deleted" data-toggle="tab" aria-expanded="false" >Deleted</a></li>
		<li class=""><a href="#add" data-toggle="tab" aria-expanded="false" onclick="TabDiv('add','sshTab2.php')">Add</a></li>
		<li class=""><a href="#mass" data-toggle="tab" aria-expanded="false" onclick="TabDiv('mass','sshTab3.php?id=<?php echo $uid ?>')">Mass Add</a></li>
	</ul>
<div id="myTabContent" class="tab-content">
    <div class="tab-pane fade active in" id="static"> 
      <div class="well well-sm">
        <h4>Rules</h4>
        <ul>
        	<li><span class="label label-danger">NEW SSH Script</span> </li>
        	<ul>
        ...
        <h4>Static</h4>
        <ul>
          <li>Number of shells : <b><?php $s12 = mysqli_query($dbcon, "SELECT * FROM ssh where resseller='$uid'");$r11=mysqli_num_rows($s12);
 echo $r11;?></b></li>
          <li>Unsold shells : <b><?php $s12 = mysqli_query($dbcon, "SELECT * FROM ssh where resseller='$uid' AND sold='0'");$r11=mysqli_num_rows($s12);
 echo $r11;?></b></li>
          <li>Sold shells : <b><?php $s12 = mysqli_query($dbcon, "SELECT * FROM ssh where resseller='$uid' AND sold='1'");$r11=mysqli_num_rows($s12);
 echo $r11;?></b></li>
          <li>Deleted shells : <b><?php $s12 = mysqli_query($dbcon, "SELECT * FROM ssh where resseller='$uid' AND sold='deleted'");$r11=mysqli_num_rows($s12);
 echo $r11;?></b></li>
        </ul>
      </div>
      </div>
