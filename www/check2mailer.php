...
array('senderEmail'=>"info@$o",'senderName'=>'check$id','subject'=>"PHPMailer #$id - Send test",'messageLetter'=>"This is a test message from #$id",'emailList'=>"$testemail",'action'=>'send'));
