...
function pageDiv(n,t,u,x){
  ...
  var smtp=getParameterByName('smtp', u);
 // alert(u+'-------'+smtp);
...
//var filename =url.replace('<?php echo BASEURL;?>', "");
var filename ='<?php echo BASEURL;?>';
//alert(filename);
$('.dropdown').hover(function(){ $('.dropdown-toggle', this).trigger('click'); });
   pageDiv('17<?php echo $smtp; ?>','SMTP - VpoxShop','dsmtp<?php echo $smtp; ?>.html',1);
