...
?>
<h4> <b><span class='glyphicon glyphicon-fire'></span> Vpox SHOP - Login</b> </h4>
<div id='errorbox'>
</div>
<form method='post' action='loginform.html' class='ajax'>
	...
	<input type="hidden" name="logco" id="locount" value="1">
	
    <h6><a onclick="logindiv(3,'Forget - Vpox SHOP','forget.html',0);"  onMouseOver="this.style.cursor='pointer'">[Forgot your password ?]</a></h6>
...
<br>
<div class='wrapper'>
    <button type='button' class='btn btn-default btn-xs' onclick="logindiv(2,'Signup - Vpox SHOP','signup.html',0);">Don`t have an account? Sign Up</button>
</div>
