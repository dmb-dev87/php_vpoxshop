...
?>
<h4> <b><span class='glyphicon glyphicon-fire'></span> Vpox SHOP - Forget</b> </h4>
<div id='errorbox'>
</div>
...
<br>
<div class='wrapper'>
    <button type='button' class='btn btn-default btn-xs' onclick="logindiv(1,'Login - Vpox SHOP','login.html',0);">Login</button> |
    <button type='button' class='btn btn-default btn-xs' onclick="logindiv(2,'Signup - Vpox SHOP','signup.html',0);">SignUp</button>
</div>
