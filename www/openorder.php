...
//echo "SELECT * FROM purchases WHERE buyer='$usrid' and id='$orderid'";
...
<tr style="border-bottom:1px solid gainsboro">
  <td>SSL</td>
  <td><b><?php if($sslvalue=='https'){echo "Yes";}else{ echo "No";} ?></b></td>
</tr>
  <tr style="border-bottom:1px solid gainsboro">
  <td>Detected Hosting</td>
  <td><b><?php echo htmlspecialchars($hosting); ?></b></td>
</tr>

  <tr style="border-bottom:1px solid gainsboro">
  <td>Domain</td>
  <td><b><?php echo $exdom[0]; ?></b></td>
</tr>
  ...
  <tr style="border-bottom:1px solid gainsboro">
  <td>Username</td>
  <td style="display: flex;"><b><input id='username' class="form-control"  onClick='this.setSelectionRange(0, this.value.length)' value='<?php echo htmlspecialchars($login); ?>' /></b><button class="btn btn-primary copyit" onclick="myFunctionuser()"><i class="fa fa-copy"></i> Copy</button></td>
</tr>

  <tr>
  <td>Password</td>
  <td style="display: flex;"><b><input id='password' class="form-control passc" onClick='this.setSelectionRange(0, this.value.length)' value='<?php echo htmlspecialchars($pass); ?>' /></b><button class="btn btn-primary copyit"  onclick="myFunctionpass()"><i class="fa fa-copy"></i> Copy</button></td>
</tr>
...
<?php
 ...
 if ($row['type'] == "mailer") {
	 $itemid = $row['id'];
	 //echo "SELECT * FROM mailers WHERE id='$itemid'";
...
?>
<script>
function myFunctionuserSmtp() {
  var copyText = document.getElementById("username_smtp");
  copyText.select();
  copyText.setSelectionRange(0, 99999)
  document.execCommand("copy");
  //alert("Copied the text: " + copyText.value);
...
<script>
function myFunctionpassSmtp() {
  var copyText = document.getElementById("password_smtp");
  copyText.select();
  copyText.setSelectionRange(0, 99999)
  document.execCommand("copy");
 //alert("Copied the text: " + copyText.value);
...
<tr>
  ...
  <tr>
  <td>HOST/IP</td>
  <td><b><input id='host/ip' class="form-control" onClick='this.setSelectionRange(0, this.value.length)' value='<?php echo htmlspecialchars($url); ?>' /></b></td>
</tr>
  ...
  <tr>
  <td>User</td>
  <td style="display: flex;"><b><input id='username_smtp' class="form-control" onClick='this.setSelectionRange(0, this.value.length)' value='<?php echo htmlspecialchars($login); ?>' /></b><button class="btn btn-primary copyit" onclick="myFunctionuserSmtp()"><i class="fa fa-copy"></i> Copy</button></td>
</tr>

  <tr>
  <td>Pass</td>
  <td style="display: flex;"><b><input id='password_smtp' class="form-control" onClick='this.setSelectionRange(0, this.value.length)' value='<?php echo htmlspecialchars($pass); ?>' /></b><button class="btn btn-primary copyit" onclick="myFunctionpassSmtp()"><i class="fa fa-copy"></i> Copy</button></td>
</tr>

  <tr>
  <td>Sender Email</td>
  <td><b><input id='senderemail' class="form-control" onClick='this.setSelectionRange(0, this.value.length)' value='<?php echo htmlspecialchars($login); ?>' /></b></td>
</tr>
