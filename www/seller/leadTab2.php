<form id="leadsAdd"><input type="hidden" name="oid" value="<?php echo $_REQUEST['id'] ?>">
<div class="row">
...
<div class="row">
  <div class="form-group col-lg-3 ">
    <label for="lead_about">Source</label>
...
</div><div class="col-md-6"><textarea name="details" class="form-control " rows="6" placeholder="Sample Lead" required></textarea></div>
...
$("#leadsAdd").submit(function() {
  $('button').prop('disabled', true);
    $.ajax({
           type: "POST",
           url: 'leadAdd.html',
           data: $("#leadsAdd").serialize(),
