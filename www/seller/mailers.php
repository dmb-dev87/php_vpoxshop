...
<ul class="nav nav-tabs">
		...
		<li class=""><a href="#delete" data-toggle="tab" aria-expanded="false" onclick="TabDiv('delete', 'mailerTab4.php')">Deleted</a></li>
		<li class=""><a href="#add" data-toggle="tab" aria-expanded="false" onclick="TabDiv('add','mailerTab2.php?id=<?php echo $uid ?>')">Add</a></li>
		<li class=""><a href="#mass" data-toggle="tab" aria-expanded="false" onclick="TabDiv('mass','mailerTab3.php?id=<?php echo $uid ?>')">Mass Add</a></li> 
	</ul>
