<form  method="POST" action="shellMass.html" target="myifram">
<input type="hidden" name="userid" value="<?php echo $_REQUEST['id'] ?>">
	<label for="text">Shell List:</label>
...
<iframe style="border:none" width="100%" height="100%" scrolling="yes" name="myifram" id="myifram" src="shellMass.html"></iframe>
